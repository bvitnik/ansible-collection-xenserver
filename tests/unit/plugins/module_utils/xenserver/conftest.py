...
def XenAPI():
    ...
    fake_xenapi = importlib.import_module('ansible_collections.bvitnik.xenserver.tests.unit.plugins.module_utils.xenserver.FakeXenAPI')
...
def xenserver(XenAPI):
    ...
    from ansible_collections.bvitnik.xenserver.plugins.module_utils import xenserver
